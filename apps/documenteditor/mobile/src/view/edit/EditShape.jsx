...
const EditShape = props => {
    ...
    const storeShapeSettings = props.storeShapeSettings,
          shapeObject = props.storeFocusObjects.shapeObject,
          imageObject = props.storeFocusObjects.imageObject,
          wrapType = storeShapeSettings.getWrapType(shapeObject || imageObject);
